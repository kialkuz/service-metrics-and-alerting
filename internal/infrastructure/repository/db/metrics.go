...
func (r *dbRepository) AddMetric(metrics model.Metrics) error {
...
func (r *dbRepository) UpdateMetric(value float64, id int) error {
...
func (r *dbRepository) GetMetric(name string) (*model.Metrics, error) {
